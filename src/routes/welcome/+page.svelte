<script lang="ts">
  ...
  import { estimateTextWidth, updateCharStates, getDisplayStates, type CharState } from '$lib/utils/text';
...
<div class="relative flex h-screen w-screen flex-col items-center justify-center gap-8">
  <div class="flex flex-wrap justify-center gap-x-6">
    <span bind:this={welcomeRef} class="font-jua text-saffron text-8xl">
      Welcome, 
    </span>
